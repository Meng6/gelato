...
rule mgdb_prepare_search_ancestors_datalog_for_bashlog:
    ...
    script:
        "../src/query/mgdb/prepare_search_ancestors_datalog_for_bashlog.py"
...
rule mgdb_prepare_search_descendants_datalog_for_bashlog:
    ...
    script:
        "../src/query/mgdb/prepare_search_descendants_datalog_for_bashlog.py"
